 ...
 * Displays permission-filtered quick action buttons
 */

import React from 'react';
import { Link } from 'react-router-dom';
import { getVisibleQuickActions, type QuickActionConfig } from '../WidgetRegistry';
...
function QuickActionButton({ action }: { action: QuickActionConfig }) {
...
export function QuickActions({ userPermissions }: QuickActionsProps) {
  const visibleActions = getVisibleQuickActions(userPermissions);
